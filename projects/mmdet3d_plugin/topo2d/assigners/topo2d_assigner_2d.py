...
class Topo2DAssigner2D(BaseAssigner):
    ...
    def __init__(self,
                 ...
                 pc_range=None, org_img_size=None):
    ...
    def assign(self,
        ...
        # normalized_gt_bboxes = normalize_2d_bbox(gt_bboxes, self.org_img_size)
        # reg_cost = self.reg_cost(bbox_pred[:, :4], normalized_gt_bboxes[:, :4])

        _, num_orders, num_pts_per_gtline, num_coords = gt_pts.shape
        normalized_gt_pts = normalize_2d_pts(gt_pts, self.org_img_size)
        ...
        # bbox_pred: xywh, normalize -> xyxy, denormalize
        # bboxes = denormalize_2d_bbox(bbox_pred, self.org_img_size)
        # iou_cost = self.iou_cost(bboxes, gt_bboxes)
        # weighted sum of above three costs
        # import pdb;pdb.set_trace()
        # [BUG] iou cost is all nan
